 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = com.meplayer.scouting.Partido.class)
public class PartidoForm extends CustomComponent implements EntityEditor {
    ...
    @AutoGenerated
    private TextField cub_localField;
    @AutoGenerated
    private TextField club_visitanteField;
    @AutoGenerated
    private TextField competicionField;
    @AutoGenerated
    private TextField faseField;
    @AutoGenerated
    private TextField jornadaField;
    @AutoGenerated
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        resultadoField.setWidth("-1px");
        resultadoField.setHeight("-1px");
        resultadoField.setCaption("Resultado");
        resultadoField.setImmediate(true);
        fieldLayout.addComponent(resultadoField);

        // cub_localField
        cub_localField = new TextField();
        cub_localField.setWidth("-1px");
        cub_localField.setHeight("-1px");
        cub_localField.setCaption("Cub_local");
        cub_localField.setImmediate(true);
        fieldLayout.addComponent(cub_localField);

        // club_visitanteField
        club_visitanteField = new TextField();
        club_visitanteField.setWidth("-1px");
        club_visitanteField.setHeight("-1px");
        club_visitanteField.setCaption("Club_visitante");
        club_visitanteField.setImmediate(true);
        fieldLayout.addComponent(club_visitanteField);

        // competicionField
        competicionField = new TextField();
        competicionField.setWidth("-1px");
        competicionField.setHeight("-1px");
        competicionField.setCaption("Competicion");
        competicionField.setImmediate(true);
        fieldLayout.addComponent(competicionField);

        // faseField
        faseField = new TextField();
        faseField.setWidth("-1px");
        faseField.setHeight("-1px");
        faseField.setCaption("Fase");
        faseField.setImmediate(true);
        fieldLayout.addComponent(faseField);

        // jornadaField
        jornadaField = new TextField();
        jornadaField.setWidth("-1px");
        jornadaField.setHeight("-1px");
        jornadaField.setCaption("Jornada");
        jornadaField.setImmediate(true);
        fieldLayout.addComponent(jornadaField);

        // fechaField
        fechaField = new TextField();
        fechaField.setWidth("-1px");
        fechaField.setHeight("-1px");
        fechaField.setCaption("Fecha");
        fechaField.setImmediate(true);
        fieldLayout.addComponent(fechaField);
