 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = com.meplayer.scouting.Jugador.class)
public class JugadorForm extends CustomComponent implements EntityEditor {
    ...
    @AutoGenerated
    private TextField fin_contratoField;
    @AutoGenerated
    private TextField anterior_clubField;
    @AutoGenerated
    private TextField caracteristicasField;
    @AutoGenerated
    private TextField virtudesField;
    @AutoGenerated
    private TextField carenciasField;
    @AutoGenerated
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        edadField.setWidth("-1px");
        edadField.setHeight("-1px");
        edadField.setCaption("Edad");
        edadField.setImmediate(true);
        fieldLayout.addComponent(edadField);

        // clubField
        clubField = new TextField();
        clubField.setWidth("-1px");
        clubField.setHeight("-1px");
        clubField.setCaption("Club");
        clubField.setImmediate(true);
        fieldLayout.addComponent(clubField);

        // fin_contratoField
        fin_contratoField = new TextField();
        fin_contratoField.setWidth("-1px");
        fin_contratoField.setHeight("-1px");
        fin_contratoField.setCaption("Fin_contrato");
        fin_contratoField.setImmediate(true);
        fieldLayout.addComponent(fin_contratoField);

        // anterior_clubField
        anterior_clubField = new TextField();
        anterior_clubField.setWidth("-1px");
        anterior_clubField.setHeight("-1px");
        anterior_clubField.setCaption("Anterior_club");
        anterior_clubField.setImmediate(true);
        fieldLayout.addComponent(anterior_clubField);

        // caracteristicasField
        caracteristicasField = new TextField();
        caracteristicasField.setWidth("-1px");
        caracteristicasField.setHeight("-1px");
        caracteristicasField.setCaption("Caracteristicas");
        caracteristicasField.setImmediate(true);
        fieldLayout.addComponent(caracteristicasField);

        // virtudesField
        virtudesField = new TextField();
        virtudesField.setWidth("-1px");
        virtudesField.setHeight("-1px");
        virtudesField.setCaption("Virtudes");
        virtudesField.setImmediate(true);
        fieldLayout.addComponent(virtudesField);

        // carenciasField
        carenciasField = new TextField();
        carenciasField.setWidth("-1px");
        carenciasField.setHeight("-1px");
        carenciasField.setCaption("Carencias");
        carenciasField.setImmediate(true);
        fieldLayout.addComponent(carenciasField);

        // agenteField
        agenteField = new TextField();
        agenteField.setWidth("-1px");
        agenteField.setHeight("-1px");
        agenteField.setCaption("Agente");
        agenteField.setImmediate(true);
        fieldLayout.addComponent(agenteField);
